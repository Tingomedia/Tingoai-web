...
const GptHome = () => {
  ...
  return (
    <div className="bg-[#121826] text-[#E5E7EB] flex flex-col justify-center items-center relative h-full">
      <div className="w-full h-full px-[16px] flex justify-center overflow-y-auto hide-scrollbar">
        <div className="flex flex-col max-w-[640px] gap-24 pt-24 pb-96">
          {(messages || repliesSample).map((reply, i) => {
            if (reply.role === "user")
