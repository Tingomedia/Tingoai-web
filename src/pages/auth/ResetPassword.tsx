                ...
                <div className="lg:w-[514px] md:w-[60%] w-[90%] lg:h-[560px] flex flex-col gap-[25px] overflow-hidden">
                    ...
                    <div className="lg:w-[514px] lg:h-[420px] h-[400px] md:h-[420px] border border-gray-700 bg-gradient-to-b from-[#797979CC] to-[#232A3E1A] bg-transparent rounded-3xl flex flex-col items-center py-10 gap-[20px]">
                        <div className="lg:w-[450px] w-[90%] text-center h-[54px] flex flex-col justify-center items-center gap-[5px]">
                            <h2 className='text-[24px] text-[#E5E7EB] font-semibold'>Reset your password</h2>
                            <p className='lg:text-[14px] text-[12px] text-[#A1A6B4] font-Poppins'>Enter your new password to access your Tingo account</p>
                        </div>
                        <form onSubmit={handleSubmit}  
                        className='h-[228px] lg:w-[450px] w-[90%] flex flex-col gap-[24px]'>
                            <div className="flex flex-col h-[80px] relative">
                                <label htmlFor="password" className='text-[#E5E7EB] text-[14px] font-poppins'>New Password</label>
                                <input 
                                id='password'
                                name='password'
                            ...
                            <div className="flex flex-col h-[80px] relative">
                                <label htmlFor="password" className='text-[#E5E7EB] text-[14px] font-poppins'>Confirm Password</label>
                                <input 
                                id='confirmPassword'
                        ...
                        className='h-[80px] p-4 lg:w-[450px] w-[100%] rounded-lg text-white font-semibold font-Inter bg-[#F8872B]'>Create Account</button>
                        </form>
                    </div>
                </div>
            </div>
