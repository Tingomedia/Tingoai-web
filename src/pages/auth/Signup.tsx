                ...
                <div className="lg:w-[514px] w-[90%] md:w-[60%] h-[884px] flex flex-col gap-[25px] overflow-hidden">
                    ...
                    <div className="lg:w-[514px] h-[650px] border border-gray-700 bg-gradient-to-b from-[#797979CC] to-[#232A3E1A] bg-transparent rounded-3xl flex flex-col items-center justify-center gap-[20px]">
                        <div className="w-[450px] h-[54px] flex flex-col justify-center items-center gap-[5px]">
                            <h2 className='lg:text-[24px] text-[#E5E7EB] font-semibold'>Sign up with your credentials</h2>
                            <p className='lg:text-[14px] text-[10px] text-[#A1A6B4] font-Poppins'>Enter your credentials to create a Tingo account</p>
                        </div>
                        <form onSubmit={(e) => {
                                e.preventDefault();
                            ...
                            {/* Confirm Password */}
                            <div className="flex flex-col h-[80px] relative">
                                <label className="text-[#E5E7EB] text-[14px]">Confirm Password</label>
                                <input
                                    type={PasswordInputType}
                                ...
                                <div className="flex lg:gap-4 gap-2">
                                    ...
                                    <span className='text-[#E5E7EB] lg:w-[372px] lg:text-[12px] text-[10px]'>
                                        By signing up, you agree to Tingo AI <button className='text-[#F8872B]'>Terms & Condition,</button> <button className='text-[#F8872B]'>Privacy</button> and <button className='text-[#F8872B]'>Policy</button>
                                    </span>
                                </div>
                        <button type="submit" disabled={formik.isSubmitting} className="h-[55px] lg:w-[450px] w-[100%] rounded-lg text-white font-semibold py-4 bg-[#F8872B] hover:bg-[#f58e39] transition duration-300">
                                {formik.isSubmitting ? <SpinnerMini /> : "Sign Up"}
                            </button>
                        </form>
                    </div>
                    <div className="flex justify-center">
                        <span className='text-[#A1A6B4] w-[268px] cursor-pointer h-[60px] bg-gradient-to-b from-[#797979CC] to-[#232A3E1A] bg-transparent border border-gradient-to-r from-[#797979CC] to-[#232A3E1A] hover:bg-gradient-to-r from-[#797979CC] to-[#232A3E1A] flex justify-center items-center gap-2 rounded-full text-[14px]'>Have an account? 
