...
const Signin: FC = (): JSX.Element => {
  ...
  return (
    <>
      ...
      <div className="lg:w-[514px] lg:h-[596px] h-[500px] text-gray-700 flex flex-col items-center py-8 gap-[15px]">
        ...
        <button
          ...
          className="bg-white font-Poppins font-semibold lg:w-[450px] md:w-[90%] w-[90%] h-[55px] rounded-lg flex justify-center items-center gap-4"
        >
          <img src={google} alt="" />
        ...
        >
          <div className="flex flex-col h-[80px] relative">
            <label htmlFor="email" className="text-[14px] font-poppins">
              Email
            </label>
            <input
              id="email"
          ...
          <div className="flex flex-col h-[80px] relative">
            <label htmlFor="password" className="text-[14px] font-poppins">
              Password
            </label>
            <input
              id="password"
