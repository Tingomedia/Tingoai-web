...
import useOutsideClick from "../../hooks/useOutsideClick";  
  ...
  const Modal4: ModalType = ({ children }) => {
    ...
    return modalContainer
      ? createPortal(
          <div className="fixed inset-0 w-full h-screen bg-opacity-40 bg-gray-600 backdrop-blur-sm  z-[1000] transition-all duration-500">
            <div
              ref={ref}
              className=" py-5 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gradient-to-b from-gray-600 to-[#121826] rounded-2xl shadow-lg border border-gray-500 transition-all duration-500 w-[320px] md:w-[60rem]"
            >
